...
export class EntityActionMapper<Entity, State, Action extends PayloadAction = PayloadAction> extends ActionMapper<
  State,
  Action
> {
  ...
  public mapEntityAction<Payload>(
    action: StaticPayloadAction<Payload, Action> | string,
    adapterFunctionGetter: (adapter: EntityAdapter<Entity>) => EntityFunction<State, Payload>,
  ): this {
